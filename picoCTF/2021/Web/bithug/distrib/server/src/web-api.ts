...
router.post("/api/register", async (req, res) => {
    ...
    // Username: At least 3 letters, numbers, dash, underscore
...
router.post("/api/repo/create", async (req, res) => {
    ...
    // Repo name: At least 3 letters, dash, underscore
    // !!! Does not check if initializeReadme is a boolean
...
router.get("/api/self", async (req, res) => {
    ...
    try {
        // !!! Uses username literally to get repository path
